...
def psnr(img1, img2, input_order='HWC', convert_to=None):
...
def ssim(img1, img2, input_order='HWC', convert_to=None):
...
class L1Evaluation:
    ...
    def __call__(self, data_dict):
        ...
        from mmderain.models.losses.pixelwise_loss import l1_loss
...
def niqe(img, input_order='HWC', convert_to='y'):
    """Calculate NIQE (Natural Image Quality Evaluator) metric.
    ...
    # we use the official params estimated from the pristine dataset.
    niqe_pris_params = np.load('mmderain/core/evaluation/niqe_pris_params.npz')
