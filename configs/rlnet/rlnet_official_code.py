...
# learning policy
runner = dict(type='EpochBasedRunner', max_epochs=242)
lr_config = dict(
    policy='Step',
    by_epoch=True,
    step=list(range(0, 242+1, 30))[1:],
    gamma=0.5
)

# hooks
custom_hooks = [
    dict(type='RLNetHyperParamAdjustmentHook', mode='official_code'),
]
